<div class="dashboard_sidebar">
    ...
    <ul class="dashboard_link">
        <li><a class="{{ request()->routeIs('vendor.dashboard') ? 'active' : '' }}"
                href="{{ route('vendor.dashboard') }}"><i class="fas fa-tachometer"></i>Dashboard</a></li>
        ...
        <li><a class="{{ request()->routeIs('vendor.profile') ? 'active' : '' }}"
