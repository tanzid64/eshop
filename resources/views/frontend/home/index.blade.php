...
@section('content')
    ...
    <!--============================
                                                                            FLASH SELL START
                                                                        ==============================-->
    @include('frontend.home.flash-sell')
    <!--============================
                                                                            FLASH SELL END
                                                                        ==============================-->
    ...
    <!-- Electronic Part 1 Start -->
    @include('frontend.home.electronic')
    <!-- Electronic Part 1 End -->


    <!-- Electronic Part 2 Start -->
    @include('frontend.home.electronic-2')
    <!-- Electronic Part 2 End -->
    ...
    <!-- Home Services Start -->
    @include('frontend.home.home-services')
    <!-- Home Services End -->

    <!-- Home Blogs Start -->
    @include('frontend.home.home-blogs')
    <!-- Home Blogs End -->
@endsection
